...
internal let SensorsList: [Sensor] = [
    ...
    // A18 Pro (MacBook Neo)
    Sensor(key: "Te05", name: "CPU efficiency core 1", group: .CPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    Sensor(key: "Te0S", name: "CPU efficiency core 2", group: .CPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    
    Sensor(key: "Tp05", name: "CPU performance core 1", group: .CPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    Sensor(key: "Tp0D", name: "CPU performance core 2", group: .CPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    
    Sensor(key: "Tg05", name: "GPU 1", group: .GPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    Sensor(key: "Tg0D", name: "GPU 2", group: .GPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    Sensor(key: "Tg0L", name: "GPU 3", group: .GPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    Sensor(key: "Tg0e", name: "GPU 4", group: .GPU, type: .temperature, platforms: Platform.a18Gen, average: true),
    ...
    Sensor(key: "PBwo", name: "Display Backlight", group: .sensor, type: .power, platforms: Platform.m5Gen + Platform.a18Gen)
]
